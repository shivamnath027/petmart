...
if(isset($_POST['username'])){
    ...
    else
    {
         ...
         window.location.assign('errorlogin.php'); 
         </script>";
        exit();        
    }
}
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.100.2/css/materialize.min.css">
 <style>
     body {
         background-image: url(logcover.jpeg);
        ...
        <div class="card">
            ...
            <div class="form-field">
                ...
                <input type="password" id="password" name="password">
                 ...
                 <h5 class="white-text text-darken-4 ic">invalid credentials!</h5><br>
                ...
                <p class="white-text x"> Login as restaurant manager?  <a href="admin.php">Click here</a></p>
            </div>
            </div>
        </div>
        </div></form>
